...
var HTMLskillsStart = '<h3 id="skills-h3">&nbsp;Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';/* "flex-column" -> "flex-box" */
...
var HTMLonlineURL = '<br><a href="#" class="onlineClassURL">%data%</a>';
